...
// other dependencies:
var pjlinkversion = require('pjlinkversion');

// create the adapter object
var adapter = utils.adapter('pjlinkdevice');

var pjlinkcontroller;
...
// PJLink Device TCP port (4352 default)
var tcpPort;

// unloading
adapter.on('unload', function (callback) {
    if (pjlinkcontroller && pjlinkcontroller.telnet) {
        try {
            // TODO: would be great if this was just pjlinkcontroller.stop()
            pjlinkcontroller.telnet.writeln("listen 0");
            pjlinkcontroller.telnet.destroy();
        }
        catch (e) {
            adapter.log.warn("Cannot stop pjlinkcontroller telnet connection:" + e.toString());
        }
    }
